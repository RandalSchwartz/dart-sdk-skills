...
1. `skills/dart-sdk-changelog`: Language features, core library APIs, `minSdk` verification, and legacy Dart modernization.
...
2. **Author Version Guide**: Create `skills/dart-sdk-changelog/references/whats-new-in-dart-X-Y.md` with side-by-side Before/After code snippets.
3. **Update Matrices**: Update `skills/dart-sdk-changelog/SKILL.md`, `version-matrix.md`, and `README.md`.
